...
policies can still restrict cross-site cookies. Configure trusted frontend origins
explicitly so CORS permits browsers to read responses only from those origins.
